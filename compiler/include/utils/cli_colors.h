 ...
 */
typedef enum {
    SLN_UTILS_CLI_COLOR_BLACK    = 0,
    SLN_UTILS_CLI_COLOR_BLUE     = 1,
    SLN_UTILS_CLI_COLOR_GREEN    = 2,
    SLN_UTILS_CLI_COLOR_CYAN     = 3,
    SLN_UTILS_CLI_COLOR_RED      = 4,
    SLN_UTILS_CLI_COLOR_MAGENTA  = 5,
    SLN_UTILS_CLI_COLOR_BROWN    = 6,
    SLN_UTILS_CLI_COLOR_LIGHTGRAY    = 7,
    SLN_UTILS_CLI_COLOR_DARKGRAY     = 8,
    SLN_UTILS_CLI_COLOR_LIGHTBLUE    = 9,
    SLN_UTILS_CLI_COLOR_LIGHTGREEN   = 10,
    SLN_UTILS_CLI_COLOR_LIGHTCYAN    = 11,
    SLN_UTILS_CLI_COLOR_LIGHTRED     = 12,
    SLN_UTILS_CLI_COLOR_LIGHTMAGENTA = 13,
    SLN_UTILS_CLI_COLOR_YELLOW       = 14,
    SLN_UTILS_CLI_COLOR_WHITE        = 15
} sln_utils_cli_color_t;
